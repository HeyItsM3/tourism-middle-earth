		...
		<body class="body-section">
			...
			<main class="listado-main content-wrapper">
				...
				<c:if test="${user.esAdmin()}">
					<div class="mb-3">
						<a href="/torre/crear-usuario.do" class="btn btn-primary" role="button"> <i
							...
							<tr>
								...
								<td>
									<c:if test="${user.admin}">
										<a href="/torre/editar-atraccion.do?id=${usuario.id}"
											class="btn btn-light rounded-0" role="button"><i
												class="far fa-edit"></i></a>
										<a href="/torre/deleteUsuario.do?id=${usuario.id}"
