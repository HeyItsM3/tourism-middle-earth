...
public class AtraccionServicio {
	...
	public Atraccion create(String name, Double cost, Double duration, String tipo, Integer capacity, String imag_u) {

		Atraccion attraction = new Atraccion(name, cost, duration, (TipoDeAtraccion.valueOf(tipo)), capacity, -1, imag_u);
